...
public class BusController {
	...
	public ResponseEntity<Bus> createProduct(
			@ApiParam(value = "The Product to be created", required = true) @RequestBody Bus b) {
		log.info("Will add a new product");  // log the action
	...
	ResponseEntity<Bus> patchProduct(
