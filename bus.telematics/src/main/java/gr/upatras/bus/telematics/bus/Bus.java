...
public class Bus {
	...
	/**
	 * @param longitude
	 * @param latitude  Initialize the {@link Bus} instance, with coordinates
	 */
	 ...
	 * @param routeId
	 * 
	 *                  Initialize the {@link Bus} instance, with coordinates and
	 *                  route ID
	 */
	 ...
	 * @param routeId
	 * 
	 *                  Initialize the {@link Bus} instance, with id, coordinates
	 *                  and route ID
	 */
	...
	/**
	 * @param routeId Set the id of the route this bus will follow
	 */
