...
public class RouteController {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Created", response = Route.class),
			@ApiResponse(code = 400, message = "Bad Request", response = Error.class),
			@ApiResponse(code = 401, message = "Unauthorized", response = Error.class),
			@ApiResponse(code = 403, message = "Forbidden", response = Error.class),
			@ApiResponse(code = 405, message = "Method Not allowed", response = Error.class),
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Updated", response = Route.class),
			@ApiResponse(code = 400, message = "Bad Request", response = Error.class),
			@ApiResponse(code = 401, message = "Unauthorized", response = Error.class),
			@ApiResponse(code = 403, message = "Forbidden", response = Error.class),
			@ApiResponse(code = 404, message = "Not Found", response = Error.class),
	...
	public ResponseEntity<Route> editRoute(@ApiParam(value = "Route Instance", required = true) @RequestBody Route r,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Updated", response = Route.class),
			...
			@ApiResponse(code = 409, message = "Conflict", response = Error.class),
			@ApiResponse(code = 500, message = "Internal Server Error", response = Error.class) })
	@RequestMapping(value = "/route/stop/{stopId}", produces = {
			"application/json;charset=utf-8" }, method = RequestMethod.GET)
	public List<Route> getRoutesByStop(
			@ApiParam(value = "Stop ID", required = true) @PathVariable("stopId") int stopId) {
